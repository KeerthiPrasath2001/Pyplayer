...
class Musicplayer():
    def __init__(self,master):
        ...
        self.unpause=True
        self.vol=1.0
        self.song_name='Ghungroo.mp3'
        self.path='G:/Docs/Tkinter/MusicPlayer'
        self.default_path='G:/Docs/Tkinter/MusicPlayer'
        self.tracks=[]
        #pygame constructor
        pygame.init()
        pygame.mixer.init()
    ...
    def widgets(self):
        ...
        self.notebk.pack()
        self.frame1=Frame(self.notebk,width=400,height=200,relief=SUNKEN,bg='black')
        self.frame2=Frame(self.notebk,width=400,height=200,relief=SUNKEN,bg='black')
        self.notebk.add(self.frame1,text='Now Playing')
        self.notebk.add(self.frame2,text='Songs List')

        #adding widgets in frame1
        ...
        self.volume_slider = Scale(self.frame1, length=100, orient=VERTICAL, from_=100, to=0, bg='white',command=self.volume_song)
        ...
        self.total_length=Label(self.song_info_frame,text="Song length:")
    ...
    def volume_song(self,val):
        pygame.mixer.music.set_volume(int(self.volume_slider.get())/100)
    def song_length(self,file):
        #Creating an MP3 object
        audio=MP3(file)
        audio_info=audio.info
        length_in_secs=int(audio_info.length)
        hours,mins,secs=self.convert(length_in_secs)
        self.total_length['text']="Length:"+str(hours)+":"+str(mins)+":"+str(secs)
